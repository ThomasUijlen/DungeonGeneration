...
public class RoomSettings : Node, ISettings
{
    [Export] int roomSeed = 0;
    ...
    public int getRandomNumber(Vector3 translation, int mi, int ma) {
        GenerationHandler.randomNumberGenerator.Seed = Convert.ToUInt64(Godot.Mathf.RoundToInt(roomSeed + translation.Length()));
